...
require_once OSS_API_PATH.DS.'conf.inc.php';
require_once OSS_API_PATH.DS.'lib'.DS.'requestcore'.DS.'requestcore.class.php';
gws_main::load_sys_class('mimetypes','','0');
require_once OSS_API_PATH.DS.'util'.DS.'oss_util.class.php';
//检测语言包
if(file_exists(OSS_API_PATH.DS.'lang'.DS.ALI_LANG.'.inc.php')){
    require_once OSS_API_PATH.DS.'lang'.DS.ALI_LANG.'.inc.php';
}else{
