...
class form {
	 ...
	 */
	public static function editor($textareaid = 'content', $toolbar = 'basic', $module = '', $catid = '', $color = '', $allowupload = 0, $allowbrowser = 1,$alowuploadexts = '',$height = 200,$disabled_page = 0, $allowuploadnum = '100') {
		$str ='';
        ...
        if($allowupload) $str .= "filebrowserUploadUrl : '".U('attachment/attachments/upload@'.SITE_PROTOCOL.SITE_URL.'/index.php',"module=".$module."&catid=".$catid."&dosubmit=1")."',\r\n";//APP_PATH
