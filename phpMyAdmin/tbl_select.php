    ...
    for ($i = 0; $i < $fields_cnt; $i ++) {
        ...
        ?>
            <input type="hidden" name="names[<?php echo $i; ?>]"
								value="<?php echo htmlspecialchars($fields_list[$i]); ?>" /> <input
								type="hidden" name="types[<?php echo $i; ?>]"
								value="<?php echo $fields_type[$i]; ?>" /> <input type="hidden"
								name="collations[<?php echo $i; ?>]"
...
<fieldset id="fieldset_select_fields">
    ...
    ?>
    </select> <input type="checkbox" name="distinct" value="DISTINCT"
					id="oDistinct" /> <label for="oDistinct">DISTINCT</label>
			</fieldset>
    ...
    ?>
		...
		<fieldset class="tblFooters">
			<input type="hidden" name="max_number_of_fields"
				...
				name="submit" value="<?php echo __('Go'); ?>" />
		</fieldset>
	</form>
