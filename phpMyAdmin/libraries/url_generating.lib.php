 ...
 *            indenting level
 * @param string $skip
 *            do not generate a hidden field for this parameter
 ...
 *
 * @param
 *            mixed assoc. array with url params or optional string with database name
 *            if first param is an array there is also an ? prefixed to the url
 *            
 * @param
 *            string - if first param is array: 'html' to use htmlspecialchars()
 ...
 *            
 * @param
 *            string - if first param is array: optional character to
 *            use instead of '?'
 ...
 *
 * @param string $encode
 *            whether to encode separator or not,
