...
class PMA_DIA extends XMLWriter
{
     ...
     *            document will be portrait or landscape
     *            
     * @return void
     *
     * @access public
...
class Table_Stats
{
     ...
     *            Whether to display ONLY keys or not
     *            
     * @return void
     *
     ...
     *            Whether to show color for tables text or not
    ...
    public function tableDraw($changeColor)
    {
        ...
        $dia->writeRaw('<dia:attribute name="obj_pos">
        ...
        foreach ($this->fields as $field) {
            $dia->writeRaw('<dia:composite type="table_attribute">
                    <dia:attribute name="name">
            ...
            $dia->writeRaw('<dia:attribute name="primary_key">
                    <dia:boolean val="' . $pm . '"/>
                </dia:attribute>
...
class Relation_Stats
{
    ...
    public function relationDraw($changeColor)
    {
        ...
        $dia->writeRaw('<dia:object type="Database - Reference" version="0" id="' . PMA_Dia_Relation_Schema::$objectId . '">
