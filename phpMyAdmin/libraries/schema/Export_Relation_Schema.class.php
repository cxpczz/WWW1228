...
class PMA_Export_Relation_Schema
{
     ...
     *
     * @param string $title
     *            title of the page displayed at top of the document
     *            
     * @return void
     *
     * @access public
     ...
     *
     * @param string $value
     *            can be pdf,svg,dia,visio,eps etc
     *            
     * @return void
     *
     * @access public
     ...
     *            page no. whose tables will be fetched in an array
     *            
    ...
    function dieSchema($pageNumber, $type = '', $error_message = '')
    {
        ...
        echo '    ' . $error_message . "\n";
        echo '</p>' . "\n";
        echo '<a href="schema_edit.php?' . PMA_generate_common_url($db) . '&do=selectpage&chpage=' . htmlspecialchars($pageNumber) . '&action_choose=0' . '">' . __('Back') . '</a>';
        echo "\n";
