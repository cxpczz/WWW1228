...
class PMA_File
{
     ...
     * before opening it.
     * The FAQ 1.11 explains how to create the "./tmp"
     * directory - if needed
     *
    ...
    function _detectCompression()
    {
        ...
        /**
         *
         * @todo get registered plugins for file compression
         *      
     ...
     *            numbers of chars/bytes to skip
     * @return boolean
     ...
     * @access public
     * @param
     *            string - BLOB repository reference
     */
