...
class FormDisplay
{
     ...
     *
     * @param bool $allow_partial_save
     *            allows for partial form saving on failed validation
     * @param bool $check_form_submit
     ...
     * @param bool $show_restore_default
     *            whether show "restore default" button besides the input field
     */
    public function display($tabbed_form = false, $show_restore_default = false)
    {
        ...
        foreach ($this->forms as $form) {
            ...
            display_fieldset_top(PMA_lang("Form_$form->name"), $form_desc, $form_errors, array(
                'id' => $form->name
            ));
     ...
     * @param Form $form            
     * @param string $field
     *            field name as it appears in $form
     * @param string $system_path
     *            field path, eg. Servers/1/verbose
     * @param string $work_path
     *            work path, eg. Servers/4/verbose
     * @param string $translated_path
     *            work path changed so that it can be used as XHTML id
     * @param bool $show_restore_default
     *            whether show "restore default" button besides the input field
     * @param mixed $userprefs_allow
     *            whether user preferences are enabled for this field
     *            (null - no support, true/false - enabled/disabled)
     * @param
     *            array &$js_default array which stores JavaScript code to be displayed
     */
