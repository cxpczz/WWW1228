 ...
 *            default value
 * @param mixed $type
 *            var type or array of values to check against $var
 ...
 *            variable to check
 * @param mixed $type
 *            var type or array of valid values to check against $var
 * @param mixed $compare
 *            var to compare with $var
 ...
 *            the error message or named error message
 * @param string|array $message_args
 *            arguments applied to $error_message
 * @return exit
 */
 ...
 *
 * @param
 *            string anchor in documentation
 *            
...
function PMA_warnMissingExtension($extension, $fatal = false, $extra = '')
{
    ...
    if ($fatal) {
        ...
        $GLOBALS['error_handler']->addError($message, E_USER_WARNING, '', '', $escape = false);
    }
}
 ...
 *            function to call for every array element
 */
 ...
 *            whitelist to check page against
 ...
 *            Filename to include in headers if empty,
 ...
 *
 * @param string $url
 *            Location of javascript, relative to js/ folder.
 *            
...
/**
 * Adds JS code snippets to be displayed by header.inc.php.
 * Adds a
 * newline to each snippet.
 *
 * @param string $str
 *            Js code to be added (e.g. "token=1234;")
 *            
 */
 ...
 * @param bool $escape
 *            Whether to escape value or keep it as it is (for inclusion of js code)
 *            
 */
