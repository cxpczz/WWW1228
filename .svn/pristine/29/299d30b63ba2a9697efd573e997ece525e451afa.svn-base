...
class PMA_GIS_Geometrycollection extends PMA_GIS_Geometry
{
     ...
     *
     * @param string $spatial
     *            GIS GEOMETRYCOLLECTION object
     * @param string $label
     *            Label for the GIS GEOMETRYCOLLECTION object
     * @param string $color
     *            Color for the GIS GEOMETRYCOLLECTION object
    ...
    {
        $geom_count = (isset($gis_data['GEOMETRYCOLLECTION']['geom_count'])) ? $gis_data['GEOMETRYCOLLECTION']['geom_count'] : 1;
