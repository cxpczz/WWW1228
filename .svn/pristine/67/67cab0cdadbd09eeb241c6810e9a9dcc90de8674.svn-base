 ...
 *      
 * @param string $db
 *            name of database, which should be synchronized
 * @param mixed $src_link
 *            link of source server, note: if the server is current PMA server, use null
 * @param mixed $trg_link
 *            link of target server, note: if the server is current PMA server, use null
 * @param bool $data
 *            if true, then data will be copied as well
 */
