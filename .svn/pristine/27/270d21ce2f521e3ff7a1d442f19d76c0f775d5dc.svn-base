...
class PMA_EPS
{
     ...
     *
     * @param integer $x_from
     *            The x_from attribute defines the start
     *            left position of the element
     * @param integer $y_from
     *            The y_from attribute defines the start
     *            right position of the element
     * @param integer $x_to
     *            The x_to attribute defines the end
     *            left position of the element
     * @param integer $y_to
     *            The y_to attribute defines the end
     *            right position of the element
...
class Table_Stats
{
     ...
     *            Page number
     * @param
     *            integer &$same_wide_width The max width among tables
