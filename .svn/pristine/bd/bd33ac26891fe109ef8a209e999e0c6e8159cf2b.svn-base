...
if (isset($GLOBALS['is_ajax_request']) && ! $GLOBALS['is_ajax_request']) {
    ...
    if (empty($GLOBALS['is_header_sent'])) {
        ...
        ?>
<meta name="OBGZip"
	content="<?php echo ($GLOBALS['cfg']['OBGzip'] ? 'true' : 'false'); ?>" />
...
<body>
        ...
        /**
         * Display heading if needed.
         * Design can be set in css file.
         */
        ...
        if (PMA_DISPLAY_HEADING && $GLOBALS['server'] > 0) {
            ...
            if ($GLOBALS['cfg']['NavigationBarIconic']) {
                echo PMA_getImage('s_host.png', '', array(
                    'class' => 'item'
                )) . "\n";
            }
            ...
            if (strlen($GLOBALS['db'])) {
                ...
                echo $separator;
                if ($GLOBALS['cfg']['NavigationBarIconic']) {
                    echo PMA_getImage('s_db.png', '', array(
                        'class' => 'item'
                    )) . "\n";
                }
