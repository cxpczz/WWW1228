 ...
 *            directrory with plugins
 * @param mixed $plugin_param
...
function PMA_pluginCheckboxCheck($section, $opt)
{
    ...
    if (isset($_GET[$opt]) || ! isset($_GET['repopulate']) && ((isset($GLOBALS['timeout_passed']) && $GLOBALS['timeout_passed'] && isset($_REQUEST[$opt])) || (isset($GLOBALS['cfg'][$section][$opt]) && $GLOBALS['cfg'][$section][$opt]))) {
 ...
 *            name of option
 * @param string $val
 *            value of option to check against
 ...
 * @param
 *            array &$list array with plugin configuration defined in plugin file
 * @param string $cfgname
 *            name of config value, if none same as $name
 ...
 *            option id
 * @param
 *            array &$opt plugin option details
 ...
 *
 * @param string $section
 *            name of config section in $GLOBALS['cfg'][$section]
 * @param
 *            array &$list array with plugin configuration defined in plugin file
