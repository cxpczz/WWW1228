...
function PMA_TableHeader($db_is_information_schema = false, $replication = false)
{
    ...
    '    <th>' . PMA_SortableTableHeader(__('Rows'), 'records', 'DESC') . PMA_showHint(PMA_sanitize(__('May be approximate. See [a@./Documentation.html#faq3_11@Documentation]FAQ 3.11[/a]'))) . "\n" . '    </th>' . "\n";
 ...
 * @param string $sort
 *            corresponds to sortable data name mapped in libraries/db_info.inc.php
