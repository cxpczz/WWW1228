 ...
 *            drizzle user name
 * @param string $password
 *            drizzle user password
 * @param bool $is_controluser            
 * @param array $server
 *            host/port/socket
 * @param bool $auxiliary_connection
 *            (when true, don't go back to login if connection fails)
