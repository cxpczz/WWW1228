 ...
 *
 * @param bool $geom_column_present
 ...
 * @param array $titles
 *            Selected title
 * @param int $foreignMaxLimit
 *            Max limit of displaying foreign elements
 * @param array $fields
 *            Array of search criteria inputs
 * @param bool $in_fbs
 *            Whether we are in 'function based search'
 * @param bool $in_zoom_search_edit
 *            Whether we are in zoom search edit
 *            
 ...
 * @param string $names
 *            Name of the column on which search is submitted
 * @param string $types
 *            Type of the field
 * @param string $collations
 *            Field collation
 * @param string $func_type
 *            Search fucntion/operator
 * @param bool $unaryFlag
 *            Whether operator unary or not
 * @param bool $geom_func
 *            Whether geometry functions should be applied
 *            
 * @return string HTML content for viewing foreing data and elements
 *         for search criteria input.
 */
