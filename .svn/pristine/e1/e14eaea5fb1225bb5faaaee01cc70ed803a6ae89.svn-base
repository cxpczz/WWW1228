...
$forms['Servers']['Server_auth'] = array(
    'Servers' => array(
        1 => array(
            'auth_type',
...
$forms['Servers']['Server_config'] = array(
    'Servers' => array(
        1 => array(
            'only_db',
            'hide_db',
...
$forms['Servers']['Server_pmadb'] = array(
    'Servers' => array(
        1 => array(
            'pmadb' => 'phpmyadmin',
            'controlhost',
...
$forms['Servers']['Server_tracking'] = array(
    'Servers' => array(
        1 => array(
