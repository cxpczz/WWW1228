 ...
 *
 * @param boolean $not_only_options
 *            whether to include form tags or not
 * @param boolean $ommit_fieldset
 *            whether to ommit fieldset tag or not
 */
    ...
    foreach ($GLOBALS['cfg']['Servers'] as $key => $server) {
        ...
        if ($list) {
            ...
            if ($selected) {
                ...
                echo '<a class="item" href="index.php' . PMA_generate_common_url(array(
                    'server' => $key
