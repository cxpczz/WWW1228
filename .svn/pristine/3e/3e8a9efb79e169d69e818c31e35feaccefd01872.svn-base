 ...
 *
 * @param
 *            server The protocol and hostname to use
 * @access public
 */
 ...
 *
 * @param
 *            cafile The path of the crt file to use
 * @access public
 */
 ...
 *
 * @param
 *            id The id of the swekey
 * @param
 *            rt The random token used to generate the otp
 * @param
 *            otp The otp generated by the swekey
...
define("SWEKEY_STATUS_NOTPLUGGED", 200);
 // This key is not plugged in the computer
