...
if ($is_create_db_priv) {
    ...
    ?>
<form method="post" action="db_create.php" id="create_database_form"
	...
	<strong>
            ...
            <input type="hidden" name="reload" value="1" /> <input
		type="text" name="new_db" value="<?php echo $db_to_create; ?>"
...
<strong><?php echo __('Create database') . ':&nbsp;' . PMA_showMySQLDocu('SQL-Syntax', 'CREATE_DATABASE'); ?></strong>
<br />
<?php
    echo '<span class="noPrivileges">' . ($cfg['ErrorIconic'] ? PMA_getImage('s_error2.png', '', array(
        'hspace' => 2,
        'border' => 0,
        'align' => 'middle'
