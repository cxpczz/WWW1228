...
class PMA_SVG extends XMLWriter
{
     ...
     *
     * @param integer $width
     *            total width of the Svg document
     * @param integer $height
     *            total height of the Svg document
     *            
     * @return void
     * @access public
     *        
     ...
     *            Svg element name
     * @param integer $x
     *            The x attr defines the left position of the element
     *            (e.g. x="0" places the element 0 pixels from the left of the browser window)
     * @param integer $y
     *            The y attribute defines the top position of the element
     ...
     * @param string $styles
     *            The style attribute defines the style the element
     ...
     *
     * @param string $text
     *            string that width will be calculated
     * @param integer $font
    ...
    function getStringWidth($text, $font, $fontSize)
    {
         ...
         */
        $count = 0;
        $count = $count + ((strlen($text) - strlen(str_replace(array(
            "i",
            "j",
            "l"
        ), "", $text))) * 0.23); // ijl
        ...
        $count = $count + ((strlen($text) - strlen(str_replace(array(
            ...
            "8",
            "9"
        ), "", $text))) * 0.56); // abdeghnopquL023456789
        $count = $count + ((strlen($text) - strlen(str_replace(array(
            "F",
            "T",
            "Z"
...
class Table_Stats
{
     ...
     *            Page number
     * @param
     *            integer &$same_wide_width The max. with among tables
...
class PMA_Svg_Relation_Schema extends PMA_Export_Relation_Schema
{
     ...
     *
     * @param boolean $changeColor
     *            Whether to show color for primary fields or not
     *            
     * @return nothing
     * @access private
     *        
