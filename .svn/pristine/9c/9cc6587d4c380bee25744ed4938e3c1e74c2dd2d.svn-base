...
<iframe id="import_upload_iframe" name="import_upload_iframe" width="1"
	height="1" style="display: none;"></iframe>
<div id="import_form_status" style="display: none;"></div>
<div id="importmain">
	<img src="<?php echo $GLOBALS['pmaThemeImage'];?>ajax_clock_small.gif"
...
?>
	...
	<input type="hidden" name="<?php echo $ID_KEY; ?>"
	...
	<div class="importoptions">
        ...
        <?php if ($GLOBALS['is_upload'] && !empty($cfg['UploadDir'])) { ?>
            <ul>
				<li><input type="radio" name="file_location" id="radio_import_file" />
                <?php PMA_browseUploadFile($max_upload_size); ?>
            </li>
				<li><input type="radio" name="file_location"
...
// charset of file
	...
	<div class="importoptions">
        ...
        <div class="formelementrow">
			<input type="checkbox" name="allow_interrupt" value="yes"
				...
				<?php echo PMA_pluginCheckboxCheck('Import', 'allow_interrupt'); ?> />
        ...
        <div class="formelementrow">
			...
			<input type="text" name="skip_queries"
				value="<?php echo PMA_pluginGetDefault('Import', 'skip_queries');?>"
            ...
            ?>
        <input type="hidden" name="skip_queries"
			value="<?php echo PMA_pluginGetDefault('Import', 'skip_queries');?>"
			id="text_skip_queries" />
            <?php
        }
	...
	<div class="importoptions" id="format_specific_opts">
		...
		<p class="no_js_msg" id="scroll_to_options_msg">Scroll down to fill in
			the options for the selected format and ignore the options for other
			formats.</p>
